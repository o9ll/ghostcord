...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@nightcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@nightcordplugins/musicControls/spotify/SpotifyStore";
