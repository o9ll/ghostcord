...
import { providers } from "@nightcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@nightcordplugins/musicControls/spotify/lyrics/providers/store";
