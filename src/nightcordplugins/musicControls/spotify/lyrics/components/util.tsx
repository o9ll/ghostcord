...
import { SpotifyLrcStore } from "@nightcordplugins/musicControls/spotify/lyrics/providers/store";
import { SyncedLyric } from "@nightcordplugins/musicControls/spotify/lyrics/providers/types";
