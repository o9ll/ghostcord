...
import IconsTab from "@ghostcordplugins/iconViewer/components/IconsTab";
...
const TABS: TabDef[] = [
    ...
    },
    {
        ...
        description: "Sync Ghostcord settings across devices",
    },
    {
        id: "language",
        label: "Language",
        ...
        description: "Change Ghostcord's interface language",
    },
];

// ── Modal inner ───────────────────────────────────────────────────────────────

function GhostcordModalInner({ onClose }: { onClose: () => void; }) {
    ...
    let TabContent = null;
    switch (activeTab) {
        case "ghostcord": TabContent = <VencordTab />; break;
...
function GhostcordModal({ modalProps }: { modalProps: ModalProps; }) {
    return (
        <ModalRoot {...modalProps} size={ModalSize.LARGE} className="nc-modal-wrapper">
            <ModalContent className="nc-modal-modal-content">
                <ErrorBoundary message="Failed to render Ghostcord Settings modal.">
                    <GhostcordModalInner onClose={modalProps.onClose} />
                </ErrorBoundary>
            </ModalContent>
        </ModalRoot>
    );
