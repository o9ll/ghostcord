...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@ghostcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@ghostcordplugins/musicControls/spotify/SpotifyStore";
