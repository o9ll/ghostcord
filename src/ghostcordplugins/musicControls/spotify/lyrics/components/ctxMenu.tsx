...
import { providers } from "@ghostcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@ghostcordplugins/musicControls/spotify/lyrics/providers/store";
