...
import { BaseText, Button, FormSwitch } from "@Ghostcord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Ghostcord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`ghostcord://assets/${asset}?v=${version}`}
                    alt=""
