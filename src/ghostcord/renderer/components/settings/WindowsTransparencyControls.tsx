...
import { Heading, Paragraph } from "@Ghostcord/types/components";
import { Margins } from "@Ghostcord/types/utils";
import { Select } from "@Ghostcord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Ghostcord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
