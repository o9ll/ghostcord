...
import { useState } from "@Ghostcord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Ghostcord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Ghostcord minimized when starting with system"}
