...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Ghostcord/types/components";
import { FluxDispatcher, InviteActions } from "@Ghostcord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Ghostcord and Ghostcord are fully up to date. You can get help in our{" "}
