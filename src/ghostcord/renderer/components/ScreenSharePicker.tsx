...
import {
    ...
    RestartIcon,
    Span
} from "@Ghostcord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Ghostcord/types/webpack/common";
...
const logger = new Logger("GhostcordScreenShare");
