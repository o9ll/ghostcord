...
// Nightcord native defaults — no external prefs file, always on
const NIGHTCORD_PREFS = { defaultPlugins: true, autoUpdate: true } as const;

export const installerPrefs = NIGHTCORD_PREFS;

handle(IpcEvents.GET_INSTALLER_PREFS, () => NIGHTCORD_PREFS);
